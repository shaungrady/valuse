...
- c54eada: add Svelte, Vue, and Angular bridges
  ...
  - `valuse/vue` — `useValuse` (read-only ref) and `useValuseModel` (writable
    ref for `v-model`), with automatic cleanup via `onScopeDispose`.
